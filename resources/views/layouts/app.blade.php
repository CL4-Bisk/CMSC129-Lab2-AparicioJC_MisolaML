        ...
        <header class="border-b border-gray-200 bg-white shadow-sm">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
                ...
                <nav class="flex items-center gap-3 text-sm">
                    <a href="{{ route('borrowed-books.index') }}" class="rounded-md px-3 py-2 hover:bg-gray-100">Books</a>
                    <a href="{{ route('borrowed-books.create') }}" class="rounded-md px-3 py-2 hover:bg-gray-100">Add Book</a>
                    <a href="{{ route('borrowed-books.trashed') }}" class="rounded-md px-3 py-2 hover:bg-gray-100">Trash</a>
                </nav>
            </div>
        </header>
